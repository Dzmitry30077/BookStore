  ...
  return (
    <>
      <div className={s.contract}>
        <div className={s.contract_title}>{title}</div>
        <ol className={s.level1}>
          <li className={s.level1_item}>
            ...
            <ol className={s.level2}>
              <li className={s.level2_item}>
          ...
          <li className={s.level1_item}>
            ...
            <ol className={s.level2}>
              <li className={s.level2_item}>
                ...
                участника как способного принимать собственные решения касаемо инновационных методов управления
                процессами.
                <ol className={s.level3}>
                  <li className={s.level3_item}>
              ...
              <li className={s.level2_item}>
                ...
                <ol className={s.level3}>
                  <li className={s.level3_item}>
                    ...
                    <ol className={s.level4}>
                      <li className={s.level4_item}>
